...
const SpinnerCore = (props: { size?: number }) => {
  ...
  return (
    <>
      <svg
        ...
        height={size}
        aria-hidden="true"
        className="inline animate-spin fill-cyan-600 text-gray-200 dark:text-gray-600"
        viewBox="0 0 100 101"
        fill="none"
...
export const LoadingSpinner = memo(SpinnerCore);

const LoadingPageSpinnerCore = () => {
  return (
    <div className="absolute right-0 top-0 flex h-screen w-screen items-center justify-center">
      <SpinnerCore size={128} />
